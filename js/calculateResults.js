// js/calculateResults.js

// Загрузка шкал через fetch (вместо assert)
let scales = {};
...
fetch('../data/scales.json')
  ...
  .catch(err => {
    console.error('Ошибка загрузки scales.json:', err);
  });
